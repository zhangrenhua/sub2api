export default {
  ...
  home: {
    ...
    trialHint: 'Free trial credits on sign-up — no credit card required',
    tags: {
    ...
    models: {
      ...
      viewDocs: 'View Docs',
      list: {
        claudeOpus: { name: 'Claude Fable 5', desc: "Anthropic's flagship reasoning model" },
  ...
  nav: {
    ...
    paymentPlans: 'Plans',
    cryptoWallet: 'USDT/TRC20 Wallet',
  ...
  imageWorkbench: {
    ...
    statusQueued: 'Queued',
    queueFull: 'Task queue is full (max {n}). Wait for running tasks to finish.',
    interrupted: 'Interrupted (page was refreshed). You can retry.',
    retry: 'Retry',
    useTemplate: 'Use preset',
    apiKey: 'Key',
    apiKeyHint: 'Key used for image billing (needs an OpenAI/Codex image group)',
    model: 'Model',
    size: 'Size',
    count: 'Count',
    upload: 'Upload images (image-to-image / edit, up to 4)',
    imageTooLarge: 'Image too large (max 20MB each)',
    maxImages: 'Up to 4 images',
    noKeyTitle: 'You have no image-capable API key yet',
    noKeyHint: 'Image generation needs a key in an OpenAI/Codex group. Create one to start (ask an admin if you have no image group access).',
    createKey: 'Create key',
    emptyChat: 'Type a prompt to start, or try an example below',
    promptPlaceholder: 'Describe the image… (Enter to send, Shift+Enter for newline)',
    generate: 'Generate',
    edit: 'Edit',
    ...
    viewAll: 'View all',
    tasksTitle: 'Image tasks',
    tasksDescription: 'Query status and results of all image tasks (run asynchronously server-side, survives refresh)',
  ...
  modelPlaza: {
    title: 'Model Plaza',
    description: 'Every available model, its pricing and public group rates on one screen',
    eyebrow: 'MODEL PLAZA',
    heroTitle: 'Every model and price,',
    heroAccent: 'on one screen',
    heroSub: 'Capability tags and billing prices for text, image and video models in a single list — paired with public group multipliers, picking and pricing is effortless.',
    metricModels: 'Models',
    metricPlatforms: 'Platforms',
    metricGroups: 'Public groups',
    groupsTitle: 'Public group pricing',
    groupsDesc: 'Default billing multiplier per public group (final cost = model price × group multiplier)',
    groupRate: 'Default billing multiplier',
    yourRate: 'Your custom rate',
    defaultRate: 'default',
    groupStandard: 'Standard',
    groupSubscription: 'Subscription',
    modelsTitle: 'Model pricing',
    modelsDesc: 'Filter by platform or search models to see input/output prices',
    ...
    perRequest: '/ request',
    perImage: '/ image',
    noPrice: 'Not priced yet',
    billingToken: 'Token',
    billingPerRequest: 'Per request',
    billingImage: 'Per image',
    billingUnknown: 'No billing',
    viewGroups: 'View {n} group rate(s)',
  ...
  admin: {
    ...
    users: {
      ...
      apiKeys: 'API Keys',
      bindInviter: {
        menuItem: 'Bind Inviter',
        title: 'Bind Inviter',
        hint: 'Manually attach an inviter for a user whose referral was missed',
        codeLabel: "Inviter's affiliate code",
        codePlaceholder: "Enter the inviter's affiliate code",
        note: 'Applies only when the user has no inviter yet; an existing inviter is never overwritten.',
        confirm: 'Bind',
        binding: 'Binding…',
        success: 'Inviter bound successfully',
        failed: 'Failed to bind inviter',
      },
    ...
    accounts: {
      ...
      anthropic: {
        ...
        simulateClaudeCli: 'Simulate Claude CLI client',
        simulateClaudeCliDesc:
          'Only applies to Anthropic API Key accounts. When enabled, requests from non-CLI clients have their outbound headers rewritten to the official Claude CLI fingerprint (User-Agent / x-stainless-* / x-app, etc.) before forwarding upstream — headers only, body untouched. Real CLI clients pass through unchanged.',
        webSearchEmulation: 'Web Search Emulation',
    ...
    settings: {
      ...
      features: {
        ...
        affiliate: {
          ...
          includeSubscription: 'Rebate on Subscription Orders',
          includeSubscriptionHint: 'When enabled, subscription purchases/renewals also accrue rebate using the rate and rules above; when off, only balance top-ups generate rebate.',
          customUsers: {
      ...
      site: {
        ...
        supportUrl: 'Support link (Telegram)',
        supportUrlHint: 'Link for the bottom-right floating support widget; leave empty to hide it',
        supportUrlPlaceholder: 'https://t.me/your_support',
      ...
      payment: {
        ...
        field_cnyPerUsdtHint: 'Plans are priced in CNY. This rate converts the CNY amount to the USDT amount to collect (e.g. 7.2 means ¥7.2 = 1 USDT).',
        field_ethRpcUrlHint: 'Ethereum JSON-RPC endpoint (Infura/Alchemy/own node) used only for one-click sweeping. Reads use Etherscan.',
  ...
  payment: {
    crypto: {
      ...
      initTitle: 'Initialize Wallet',
      initHint: 'Generate a new master mnemonic, or import an existing one. The mnemonic is the ONLY backup — store it offline. Leave empty to generate.',
      importPlaceholder: 'Optional: paste an existing BIP39 mnemonic to import',
      totpCode: 'TOTP code',
      initButton: 'Initialize',
      initSuccess: 'Wallet initialized',
      backupTitle: '⚠ Back up this mnemonic now',
      backupWarning: 'This is shown only once. Anyone with it controls all deposit funds; losing it makes funds unrecoverable. Write it down offline.',
      backupDone: 'I have backed it up',
      depositTotal: 'Deposit Total',
      addresses: 'addresses',
      collectionBalance: 'Collection Balance',
      feeTrx: 'Gas Wallet (TRX)',
      actions: 'Actions',
      refreshBalances: 'Refresh Balances',
      refreshed: 'Refreshed {n} addresses',
      sweepButton: 'One-click Sweep',
      sweepStarted: 'Sweep job started',
      collectionAddress: 'Collection Address',
      collectionPlaceholder: 'TRON address to consolidate funds into',
      collectionHint: 'Funds are swept here. Keep this a cold address you control.',
      ...
      swept: 'Swept',
      createdAt: 'Created',
      sweepConfirmTitle: 'Confirm Sweep',
      sweepConfirmMessage: 'This will fund gas and transfer all deposit balances to the collection address. Enter your TOTP code to proceed.',
      erc20Section: 'USDT / ERC20 (Ethereum)',
      feeEth: 'Gas Wallet (ETH)',
      ethCollectionAddress: 'ETH Collection Address',
      sweepErc20Button: 'One-click Sweep (ERC20)',
      sweepErc20ConfirmTitle: 'Confirm ERC20 Sweep'
    },
    title: 'Recharge / Subscription',
    amountLabel: 'Amount',
    ...
    qr: {
      ...
      scanUsdt: 'Pay with {token} ({network})',
      scanUsdtHint: 'Copy the receiving address below and transfer the amount above from your wallet or exchange (OKX, Binance, …)',
      amountUsdt: 'Amount',
      address: 'Receiving Address',
      usdtNetworkWarning: 'Send only {token} on the {network} network, exactly the amount above. Wrong network or amount may not be credited.',
    ...
    errors: {
      ...
      USDT_MIN_AMOUNT: 'USDT payment requires a minimum of ¥{min_cny}.',
      USDT_RATE_NOT_CONFIGURED: 'USDT exchange rate is not configured. Please contact the administrator.',
