export default {
  ...
  payment: {
    ...
    qr: {
      ...
      scanUsdt: 'Pay with USDT ({network})',
      scanUsdtHint: 'Scan with your wallet or exchange (OKX, Binance, …), or copy the address below',
      amountUsdt: 'Amount',
      address: 'Receiving Address',
      usdtNetworkWarning: 'Send only USDT on the {network} network, exactly the amount above. Wrong network or amount may not be credited.',
