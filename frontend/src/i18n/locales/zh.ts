export default {
  ...
  imageWorkbench: {
    ...
    taskQueue: '任务队列',
    statusQueued: '排队中',
    queueFull: '任务队列已满（最多 {n} 个），请等待完成后再提交',
    interrupted: '已中断（刷新了页面），可重试',
    retry: '重试',
    useTemplate: '套用预设',
    apiKey: '秘钥',
    apiKeyHint: '选择用于生图计费的秘钥（需 OpenAI/Codex 图片分组）',
    model: '模型',
    size: '尺寸',
    count: '数量',
    upload: '上传图片（图生图 / 编辑，最多 4 张）',
    imageTooLarge: '单张图片过大（上限 20MB）',
    maxImages: '最多上传 4 张图片',
    noKeyTitle: '你还没有可用于画图的秘钥',
    noKeyHint: '画图需要一个 OpenAI/Codex 分组的秘钥；新建后即可开始（若无图片分组权限请联系管理员）',
    createKey: '新建秘钥',
    emptyChat: '输入提示词开始画图，或试试下面的示例',
    promptPlaceholder: '描述你想画的内容…（Enter 发送，Shift+Enter 换行）',
    generate: '生成',
    edit: '编辑',
    generating: '生成中…',
    editThis: '改这张',
    ...
    viewAll: '查看全部',
    tasksTitle: '生图任务',
    tasksDescription: '查询所有生图任务的状态与结果（服务端异步执行，刷新页面不丢）',
    backToStudio: '返回创作台',
    filterAll: '全部',
    filterRunning: '执行中',
    filterDone: '已完成',
  ...
  modelPlaza: {
    title: '模型广场',
    description: '一屏看清所有可用模型、定价与公开分组倍率',
    eyebrow: 'MODEL PLAZA · 模型广场',
    heroTitle: '所有可用模型与价格，',
    heroAccent: '一屏看清',
    heroSub: '把文本、图像、视频模型的能力标签与计费价格集中到一个清单，配合公开分组倍率，选型与核价一目了然。',
    metricModels: '可用模型',
    metricPlatforms: '模型平台',
    metricGroups: '公开分组',
    groupsTitle: '公开分组定价',
    groupsDesc: '公开分组的默认计费倍率（最终扣费 = 模型单价 × 分组倍率）',
    groupRate: '默认计费倍率',
    yourRate: '你的专属倍率',
    defaultRate: '默认',
    groupStandard: '标准',
    ...
    modelsTitle: '模型价格',
    modelsDesc: '按平台筛选或搜索模型，查看输入/输出单价',
  ...
  admin: {
    ...
    users: {
      ...
      bindInviter: {
        menuItem: '绑定邀请人',
        title: '绑定邀请人',
        hint: '为漏绑邀请关系的用户手动补绑邀请人',
        codeLabel: '邀请人的邀请码',
        codePlaceholder: '输入邀请人的邀请码',
        note: '仅当该用户尚未绑定邀请人时生效；已绑定不会被覆盖。',
        confirm: '绑定',
        binding: '绑定中…',
        success: '邀请人绑定成功',
        failed: '邀请人绑定失败',
    ...
    settings: {
      ...
      site: {
        ...
        supportUrl: '客服链接 (Telegram)',
        supportUrlHint: '右下角悬浮客服入口的链接，留空则不显示',
      ...
      payment: {
        ...
        field_cnyPerUsdtHint: '套餐以人民币计价。此汇率将人民币金额折算成应收 USDT 金额（如 7.2 表示 ¥7.2 = 1 USDT）。',
        field_ethRpcUrlHint: '以太坊 JSON-RPC 节点（Infura/Alchemy/自建），仅用于一键归集；读链用 Etherscan。',
  ...
  payment: {
    crypto: {
      title: 'USDT / TRC20 钱包',
      initTitle: '初始化钱包',
      initHint: '生成新的主助记词，或导入已有助记词。助记词是唯一的备份，请离线保管。留空则自动生成。',
      importPlaceholder: '可选：粘贴已有 BIP39 助记词以导入',
      totpCode: 'TOTP 验证码',
      initButton: '初始化',
      initSuccess: '钱包已初始化',
      backupTitle: '⚠ 请立即备份助记词',
      backupWarning: '此助记词仅显示一次。任何持有者都能控制全部充值资金，丢失则资金无法找回。请离线抄写保存。',
      backupDone: '我已备份',
      depositTotal: '充值地址总额',
      addresses: '个地址',
      collectionBalance: '归集地址余额',
      feeTrx: '燃料钱包 (TRX)',
      actions: '操作',
      refreshBalances: '刷新余额',
      refreshed: '已刷新 {n} 个地址',
      sweepButton: '一键归集',
      sweepStarted: '归集任务已启动',
      collectionAddress: '归集地址',
      collectionPlaceholder: '资金归集到的 TRON 地址',
      collectionHint: '资金将归集到此地址。请使用你掌控的冷地址。',
      ...
      swept: '已归集',
      createdAt: '创建时间',
      sweepConfirmTitle: '确认归集',
      sweepConfirmMessage: '将为各充值地址充值 gas 并把全部余额转入归集地址。输入 TOTP 验证码以继续。',
      erc20Section: 'USDT / ERC20（以太坊）',
      feeEth: '燃料钱包 (ETH)',
      ethCollectionAddress: 'ETH 归集地址',
      sweepErc20Button: '一键归集 (ERC20)',
      sweepErc20ConfirmTitle: '确认 ERC20 归集'
    },
    title: '充值/订阅',
    amountLabel: '充值金额',
    paymentAmount: '支付金额',
    ...
    qr: {
      scanToPay: '请扫码支付',
      scanUsdt: '使用 {token}（{network}）支付',
      scanUsdtHint: '复制下方收款地址，使用钱包或交易所（OKX、币安等）按上方金额转账',
      amountUsdt: '支付金额',
      address: '收款地址',
      usdtNetworkWarning: '请仅通过 {network} 网络转账 {token}，且金额与上方完全一致。网络或金额错误可能无法到账。',
      scanAlipay: '支付宝扫码支付',
      scanWxpay: '微信扫码支付',
    ...
    errors: {
      ...
      INVALID_AMOUNT: '金额无效',
      USDT_MIN_AMOUNT: 'USDT 支付最低 ¥{min_cny} 起',
      USDT_RATE_NOT_CONFIGURED: '未配置 USDT 汇率，请联系管理员',
      INVALID_INPUT: '参数有误',
