...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	cryptoWalletService := service.NewCryptoWalletService(client, secretEncryptor)
	paymentService := service.ProvidePaymentService(client, registry, defaultLoadBalancer, redeemService, subscriptionService, paymentConfigService, userRepository, groupRepository, affiliateService, notificationEmailService, cryptoWalletService)
	...
	cryptoWalletHandler := admin.NewCryptoWalletHandler(cryptoWalletService, totpService)
	affiliateHandler := admin.NewAffiliateHandler(affiliateService, adminService)
	complianceHandler := admin.NewComplianceHandler(settingService)
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, adminAPIKeyHandler, scheduledTestHandler, channelHandler, channelMonitorHandler, channelMonitorRequestTemplateHandler, contentModerationHandler, paymentHandler, cryptoWalletHandler, affiliateHandler, complianceHandler)
	...
	imageWorkbenchRepository := repository.NewImageWorkbenchRepository(db)
	imageWorkbenchService := service.ProvideImageWorkbenchService(imageWorkbenchRepository, configConfig, apiKeyService)
	imageWorkbenchHandler := handler.NewImageWorkbenchHandler(imageWorkbenchService, apiKeyService)
