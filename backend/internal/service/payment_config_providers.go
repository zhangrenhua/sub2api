...
var providerPendingOrderProtectedConfigFields = map[string]map[string]struct{}{
	...
	payment.TypePayPal:    {"clientid": {}, "clientsecret": {}, "webhookid": {}, "apibase": {}},
}
...
var validProviderKeys = map[string]bool{
	payment.TypeEasyPay: true, payment.TypeAlipay: true, payment.TypeWxpay: true, payment.TypeStripe: true, payment.TypeAirwallex: true, payment.TypeTRC20: true, payment.TypeERC20: true, payment.TypeUSDC: true, payment.TypePayPal: true,
}
