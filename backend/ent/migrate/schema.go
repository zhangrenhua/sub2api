...
var (
	...
	AccountsColumns = []*schema.Column{
		...
		{Name: "simulate_claude_cli_client", Type: field.TypeBool, Default: false},
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "video_price_per_second_hd", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
		{Name: "video_model_pricing", Type: field.TypeJSON, SchemaType: map[string]string{"postgres": "jsonb"}},
		...
		{Name: "path_variable", Type: field.TypeString, Size: 128, Default: ""},
